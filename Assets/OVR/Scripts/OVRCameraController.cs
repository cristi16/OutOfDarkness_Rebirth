...
{		
	...
	public bool  		TrackerRotatesX	= false;
...
//		OVRDevice.SetHeadModel(EyeCenterPosition.x, EyeCenterPosition.y, EyeCenterPosition.z);
	...
	public void GetTrackerRotatesX(ref bool trackerRotatesX)
	{
		trackerRotatesX = TrackerRotatesX;
	}

	public void SetTrackerRotatesX(bool trackerRotatesX)
	{
		TrackerRotatesX = trackerRotatesX;
	}
